<?php
	$m = 'Hi my nAme iS MaTThew';
	$m2 = "A 'quote' is <b>bold</b>";

	$a = array(1,2,3,4,5);
	$b = array(4,5,6,7,8);
	$c = array();
	$d = array(1 => 'mike',2 => 'matt',3 => 'marcus');
	...
	$obj->arrayChunk($a,2);
	$obj->arrayCombine($a,$b);
	$obj->arrayDiff($a,$b);
	$obj->arrayDiffKey($a,$b);
	$obj->arrayFill($c,2,5,9);
	$obj->arrayFillKeys($b,9);
	$obj->arrayKeyExists(3,$d);
	$obj->arrayKeys($d);
	$obj->arrayPop($a);
	$obj->arraySearch('matt',$d);
	...
	class main
	{
		...
		public function stringPos($myString, $findMe)
		{
